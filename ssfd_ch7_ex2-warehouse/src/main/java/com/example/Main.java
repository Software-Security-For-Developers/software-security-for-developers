...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Sign the encrypted output and write signature next to it in app root
            Path sigPath = SignOutput.signAndWriteToAppRoot(encrypted, "refunds.json.ecc.sig");
            System.out.println("Wrote signature to: " + sigPath.toAbsolutePath());
        } catch (Exception e) {
